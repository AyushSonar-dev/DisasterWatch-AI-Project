...
const mockAlerts: DisasterAlert[] = [
  {
    ...
    message: "Immediate evacuation required for residents in Zone A. Follow designated evacuation routes.",
  ...
  },
  {
    ...
    message: "Aftershocks expected in the next 24 hours. Stay prepared and avoid damaged structures.",
      ...
      <div className="pt-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-primary glow-text mb-2">User Dashboard</h1>
              <p className="text-gray-300">Monitor disasters, stay informed, and contribute to community safety</p>
            </div>
          ...
          {mockAlerts.length > 0 && (
            <div className="mb-8 space-y-4">
              <h2 className="text-xl font-semibold text-primary glow-text">Emergency Alerts</h2>
              {mockAlerts.map((alert) => (
                <UIAlert key={alert.id} className={`${alertTypeColors[alert.type]} border-2 glow-green-hover`}>
                  <AlertTriangle className="h-4 w-4" />
                  <AlertDescription>
                    <div className="flex justify-between items-start">
                      <div>
                        <div className="font-semibold text-white">{alert.title}</div>
                        <div className="text-gray-200 mt-1">{alert.message}</div>
                        <div className="text-sm text-gray-400 mt-2">
                          {alert.location} • {alert.timestamp}
                        </div>
                      </div>
                      <Badge className="bg-primary/20 text-primary border-primary/30">{alert.type}</Badge>
                    </div>
                  </AlertDescription>
                </UIAlert>
              ))}
          ...
          <div className="grid lg:grid-cols-3 gap-8">
                ...
                <CardContent>
                  <div className="relative h-96 bg-gradient-to-br from-gray-900 to-black rounded-lg border border-primary/20 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 bg-black/80 backdrop-blur-sm rounded-lg p-3 border border-primary/20">
                      <div className="text-xs font-medium text-primary mb-2">Severity Levels</div>
            ...
            <div className="space-y-6">
              <Card className="bg-black border-2 border-primary/20 shadow-[0_0_20px_rgba(34,197,94,0.3)] hover:shadow-[0_0_30px_rgba(34,197,94,0.4)] transition-all duration-300">
                <CardHeader>
                  <CardTitle className="text-primary glow-text">Quick Actions</CardTitle>
                </CardHeader>
              ...
              <Card className="bg-black border-2 border-primary/20 shadow-[0_0_20px_rgba(34,197,94,0.3)] hover:shadow-[0_0_30px_rgba(34,197,94,0.4)] transition-all duration-300">
                ...
                <CardContent className="space-y-3">
                  <div className="p-3 bg-gray-900/50 rounded-lg border border-primary/10">
                    <h4 className="font-medium text-primary mb-1">Earthquake Safety</h4>
                    <p className="text-sm text-gray-300">Drop, Cover, and Hold On during shaking</p>
                  </div>
                  <div className="p-3 bg-gray-900/50 rounded-lg border border-primary/10">
                    <h4 className="font-medium text-primary mb-1">Wildfire Preparedness</h4>
                    <p className="text-sm text-gray-300">Create defensible space around your home</p>
                  </div>
                  <div className="p-3 bg-gray-900/50 rounded-lg border border-primary/10">
                    <h4 className="font-medium text-primary mb-1">Flood Response</h4>
                    <p className="text-sm text-gray-300">Never drive through flooded roads</p>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="mt-8">
            <Card className="bg-black border-2 border-primary/20 shadow-[0_0_20px_rgba(34,197,94,0.3)] hover:shadow-[0_0_30px_rgba(34,197,94,0.4)] transition-all duration-300">
              <CardHeader>
                <CardTitle className="text-primary glow-text">Recent Disasters ({mockDisasters.length})</CardTitle>
                <CardDescription className="text-gray-300">
                  ...
                  {mockDisasters.map((disaster) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() => setSelectedDisaster(selectedDisaster === disaster.id ? null : disaster.id)}
                      >
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <h3 className="font-medium text-white">{disaster.location}</h3>
                            ...
                            <div className="flex items-center space-x-2 mt-1">
                              ...
                              <Badge className="bg-primary/20 text-primary border-primary/30">{disaster.status}</Badge>
                            </div>
                          </div>
                        </div>
